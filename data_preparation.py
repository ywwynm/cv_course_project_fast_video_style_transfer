...
np.save(data_dir + '\ori_tes_train.npy', ori_res_train)
np.save(data_dir + '\\trs_tes_train.npy', trs_res_train)

ori_res_test = res_calc.get_residuals(ori_dir, 1200, 1798)
trs_res_test = res_calc.get_residuals(trs_dir, 1200, 1798)

np.save(data_dir + '\ori_tes_test.npy', ori_res_test)
np.save(data_dir + '\\trs_tes_test.npy', trs_res_test)
